...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.SelfIntroduction = field.NewString(tableName, "self_introduction")
...
func (u *user) updateTableName(table string) *user {
	...
	u.SelfIntroduction = field.NewString(table, "self_introduction")
...
func (u *user) fillFieldMap() {
	...
	u.fieldMap["self_introduction"] = u.SelfIntroduction
}
