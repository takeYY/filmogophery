...
import {
  getWatchlist,
  WatchlistItem,
} from "../../services/get-watchlist/get-watchlist.service";

const querySchema = z.object({
  limit: z.coerce.number().int().positive().max(12).default(12),
...
export default function (app: AppType) {
  app.get(
    ...
    async (c) => {
      ...
      return c.json(result.value satisfies WatchlistItem[], StatusCodes.OK);
    },
  );
}
